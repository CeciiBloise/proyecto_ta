                    ...
                    <tr>
                        <th scope="row">Nombre
                            <div class="float-right">
                                ...
                                <?php else : ?>
                                    <a href="tabla_planos_bosques.php?columna=nombre_bosques&tipo=asc"><svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 96 960 960" width="20"><path d="M450 896V370L202 618l-42-42 320-320 320 320-42 42-248-248v526h-60Z"/></svg></a><!-- De A a Z ascendente-->
                                <?php endif; ?>
                                ...
                                <?php else : ?>
                                    <a href="tabla_planos_bosques.php?columna=nombre_bosques&tipo=desc"><svg xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 96 960 960" width="20"><path d="M480 896 160 576l42-42 248 248V256h60v526l248-248 42 42-320 320Z"/></svg></a>
                                <?php endif; ?>
                            </div>
                        </th>
                        <th>Descripcion</th>
