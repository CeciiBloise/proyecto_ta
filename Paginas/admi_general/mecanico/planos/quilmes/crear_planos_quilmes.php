        ...
        <div class="form_carga">
            <form action="insertar_planos_quilmes.php" method="POST" enctype="multipart/form-data" class="form">
                ...
                <div class="inputContainer">
                  ...
                  <input type="text" name="nombre_quilmes" placeholder="Nombre" required>
                </div>
                ...
                <div class="inputContainer">
                  ...
                  <input type="text" name="categoria_quilmes" placeholder="Categoria" required>
                </div>
                <div class="inputContainer">
                  <label>Archivo</label> 
                  <input type="file" name="plano_quilmes" accept="application/*" required>
                </div>     
                <div class="boton">
